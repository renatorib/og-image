...
const sansDir = `${__dirname}/../fonts/PTSans-Regular.ttf`;
const sans = readFileSync(sansDir).toString("base64");

const serifDir = `${__dirname}/../fonts/PTSerif-Regular.ttf`;
const serif = readFileSync(serifDir).toString("base64");
...
function getCss() {
  return `
    @font-face {
      ...
      font-style:  normal;
      font-weight: normal;
      src: url(data:font/ttf;charset=utf-8;base64,${sans}) format('ttf');
    }
    ...
    @font-face {
      ...
      font-style:  normal;
      font-weight: normal;
      src: url(data:font/ttf;charset=utf-8;base64,${serif}) format('ttf');
    }
